<?php /*a:1:{s:61:"D:\phpStudy\WWW\tp5\application/admin/view\index\welcome.html";i:1518078027;}*/ ?>
<html>
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <link href="/static/admincss/index.css" rel="stylesheet" type="text/css">
    <link href="/static/admincss/perfect-scrollbar.min.css" rel="stylesheet" type="text/css">
    <link href="/static/admincss/purebox.css" rel="stylesheet" type="text/css">
            ...
            <div class="contentWarp_item clearfix">
                <div class="section_select">
                    <div class="item item_price">
                        <i class="icon"><img src="/static/adminimg/1.png" width="71" height="74"></i>
                        <div class="desc">
                    ...
                    <div class="item item_order">
                        <i class="icon"><img src="static/adminimg/2.png"></i>
                        <div class="desc">
                    ...
                    <div class="item item_comment">
                        <i class="icon"><img src="/static/adminimg/3.png" width="90" height="86"></i>
                        <div class="desc">
                            <div class="tit"><?php echo htmlentities($count['comment']); ?></div>
                            <span>今日待审评论数</span>
                        </div>
                    </div>
                    <div class="item item_flow">
                        <i class="icon"><img src="/static/adminimg/4.png" width="86"></i>
                        <div class="desc">
                    ...
                    <div class="sc_warp" style="padding-bottom: 30px;">
                        <table cellpadding="0" cellspacing="0" class="system_table">
                            ...
                            <tr>
                                ...
                                <td class="gray_bg">网站授权:</td>
                                <td><a href="#" >沃好授权</a></td>
                                <td class="gray_bg">沃好首页:</td>
                                <td><a href="http://www.walhao.com" target="_blank">沃好商城</a></td>
        ...
        <div class="contentWarp">
            <div class="section system_section" style="float: none;width: inherit;">
                <div class="system_section_con">
                    ...
                    <div class="sc_warp" id="system_warp" style="display:none;padding-bottom: 30px;">
                        <table cellpadding="0" cellspacing="0" class="system_table">
                            <tbody><tr>
...
<div id="footer" style="position: static; bottom: 0px; font-size:14px;">
    <p><b>版权所有 © 2012-2017 杭州沃好电子商务有限公司，并保留所有权利。</b></p>
</div>
...
<script type="text/javascript" src="/static/adminjs/jquery.purebox.js"></script>
<script type="text/javascript" src="/static/adminjs/echart/echarts.min.js"></script>
<script type="text/javascript">
   ...
   $("#system_section").click(function(){
           if($("#system_warp").css('display')=='none')
